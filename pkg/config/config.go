...
type Config struct {
	...
	// DriftedNodeExpiration is used for setting the expiration time for nodes that are marked as drifted from Karpenter node claims
	DriftedNodeExpiration time.Duration
